...
function Shoe(props) {
  const ref = useRef()
  const { nodes, materials } = useGLTF('/models/nike/nike_air_zoom_pegasus_36-transformed.glb')
  useFrame((state) => {
...
useGLTF.preload('/models/nike/nike_air_zoom_pegasus_36-transformed.glb')
